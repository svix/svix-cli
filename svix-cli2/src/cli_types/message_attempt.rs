...
use clap::Args;
use svix::api::{self, MessageStatus, StatusCodeClass};
...
impl From<MessageAttemptListByMsgOptions> for api::MessageAttemptListOptions {
    fn from(
...
impl From<MessageAttemptListAttemptedDestinationsOptions> for api::ListOptions {
    fn from(
